...
handoff to analyst to formulate a revised research question on a single, explicitly reported coherence metric from Zhang et al., 2023, such as output token coherence over time under continuous or intermittent input, without extrapolation to per-interval drift or decay rates
