...
handoff to analyst to refine research question to focus on a single, directly measurable retention metric from Kumar et al., 2024, under periodic input and bounded token budgets, with explicit update interval and token budget conditions, and limited to one rep
