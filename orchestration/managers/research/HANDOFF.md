...
Loop: research-1789651535062. Stage: publish.
...
Latest instance: research-1789651535062-08-manager-final (completed).
...
See [status](STATUS.md) and the versioned [instance](../../instances/research-1789651535062-08-manager-final.json). At most two plan reviews and two deliverable reviews; no implementation is enabled.
